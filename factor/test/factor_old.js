...
var FactorVerifier = require("../contracts/FactorVerifier.sol");

contract('Verifier1', function (accounts) {
  ...
  before(function () {
    return Verifier.new({ from: web3.eth.accounts[0], value: 10000000000000000000, gas: 2100000 })
      .then(function (instance) {
        // Get a reference to the deployed token contract, as a JS object.
        verifier = instance;
      });
  });
